...
class MHTT(ControlProblem):
    ...
    def _setup_step(self, index, current_node:ProgressNode, guess):
        ...
        self.constraint(next_node.track_progress >= current_node.track_progress, description="Progress Constraint")

        self.constraint(self.opti.bounded(0, next_node.track_progress, 1), description="Progress Constraint")
        return current_node
